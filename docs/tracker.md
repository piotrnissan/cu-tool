...
- ✅ **TH-35**: Generate regression report (precision per component + pass/fail/insufficient) (Size: M, Risk: Low) — Done 2026-01-28
- ✅ **TH-36**: Implement gate validator with sample size check (Size: S, Risk: Low) — Done 2026-01-28
- ✅ **TH-37**: Document gates in `docs/visual-proof/quality-gates.md` (Size: S, Risk: Low) — Done 2026-01-28
